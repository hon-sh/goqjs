# goqjs SSR bench — N=1500 (render-heavy list size)
...
Same Vite IIFE for Bun / Deno / goqjs. Deno: `deno_parallel=0`.
...
| goqjs-c1 | 58.7 | 17.03 | 17.09 | 19.50 | 21.24 |
| goqjs-c16 | 56.9 | 17.56 | 17.61 | 19.77 | 21.05 |
...
| goqjs-c1 | 68.3 | 784.0 | 844.0 | 886.1 | 887.5 |
| goqjs-c16 | 411.7 | 122.8 | 123.9 | 145.2 | 152.7 |
...
| goqjs-c1 | 7.5 | 979.1 | 958.3 | 1371.6 | 1491.4 |
| goqjs-c16 | 54.0 | 145.0 | 144.6 | 153.9 | 156.6 |

---

## Analysis

1. **Latency**：goqjs ≈ **2.3×** bun（17ms vs 7ms）；有 `delay=5` 托底，比 fib 的 5–7× 温和。c16 对单请求几乎无帮助。
